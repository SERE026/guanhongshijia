 ...
 */
public class DonotViewPage extends ViewGroup {
    private static final String TAG = "DonotViewPage";
    ...
    public DonotViewPage(Context context) {
        super(context);
        initViewPager();
    }

    public DonotViewPage(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViewPager();
    }
