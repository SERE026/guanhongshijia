...
import com.wckj.gfsj.Fragment.MyOrderFragment;
...
public class MyOrderActivity extends BaseNewActivity implements View.OnClickListener {
    ...
    private View view;
    private TextView mTvMyOrder, mTvBankCard;
    ...
    private void initView() {
        mTvMyOrder = (TextView) view.findViewById(R.id.tv_my_order);
...
//        transaction.setTransition(FragmentTransaction.TRANSIT_FRAGMENT_FADE);
    ...
    private void setMainColor(int id){
        mTvMyOrder.setBackgroundColor(getResources().getColor(R.id.tv_my_order==id?R.color.white:R.color.color_97888a));
        mTvBankCard.setBackgroundColor(getResources().getColor(R.id.tv_bank_card==id?R.color.white:R.color.color_97888a));
        mTvMyOrder.setTextColor(getResources().getColor(R.id.tv_my_order==id?R.color.color_444444:R.color.color_e3e6eb));
