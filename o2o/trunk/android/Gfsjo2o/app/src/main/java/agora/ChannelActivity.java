...
public class ChannelActivity extends BaseEngineEventHandlerActivity {
    ...
    void setupRtcEngine() {
        ...
        // setup engine
        ((AppApplication) getApplication()).setRtcEngine(vendorKey);
        rtcEngine = ((AppApplication) getApplication()).getRtcEngine();
//        LogUtil.log.d(getApplicationContext().getExternalFilesDir(null).toString() + "/agorasdk.log");
        ...
        ((AppApplication) getApplication()).setEngineEventHandlerActivity(this);
    ...
    protected void onDestroy() {
        super.onDestroy();
        ((AppApplication) getApplication()).setEngineEventHandlerActivity(null);
    }
}