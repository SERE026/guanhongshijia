...
public class LoginActivity extends BaseActivity {
    ...
    private void initViews() {
        ...
        this.mVendorKey.setText(getSharedPreferences(getClass().getName(), Context.MODE_PRIVATE).getString(ChannelActivity.EXTRA_VENDOR_KEY, "d758a169a5b84dba8f89d1364e98b475"));
