...
public class SecurityClient {
    ...
    public String decrypt(String data, String type, String session) throws SecretException {
        ...
        if (NICK.equals(type)) {
            ...
            secretDataDO = secretCore.getSecretData(data, NICK_SEPARATOR_CHAR);
        } else if (PHONE.equals(type)) {
            if (!(data.startsWith(PHONE_SEPARATOR) && data.endsWith(PHONE_SEPARATOR))) {
                return data;
            }
            secretDataDO = secretCore.getSecretData(data, PHONE_SEPARATOR_CHAR);
        } else if (NORMAL.equals(type)) {
            if (!(data.startsWith(NORMAL_SEPARATOR) && data.endsWith(NORMAL_SEPARATOR))) {
                return data;
            }
            secretDataDO = secretCore.getSecretData(data, NORMAL_SEPARATOR_CHAR);
        } else {
