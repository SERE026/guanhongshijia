$(function() {
	...
	jQuery.focus = function(slid) {
		...
		var btn = "<div class='btnBg'></div><div class='preNext pre'></div><div class='preNext next'></div><div class='LiBtn'><div><div class='btn'>";
		for(var i=0; i < len; i++) {
			var ii = i+1;
			btn += "<span></span>";
		}
		...
		$(slid + " ul li").css("width", sWidth * (len) / 3);
		$(slid + " ul li a").css("width", sWidth * (len) / 3);
		$(slid + " ul li img").css("width", sWidth * (len)/3);
